<div class="content">
    <div class="col-md-12"><button class="btn btn-primary hidden" id="openModalDialogBtn" type="button" data-toggle="modal" data-target="#formCategory" data-whatever="@mdo">Open</button>
                        ...
                        <form id="category-form">
                            ...
                            <div class="form-group"><label class="form-control-label"
                                    ...
                                    <?php foreach($publishers as $publisher){ ?>
                                        <option value='<?=$publisher['id']?>'></option> <?=$publisher['name']?>
                                    <?php } ?>
                                </select></div>
                            <input id="form-book-id"
                                   type="hidden" name="id" /><input id="form-book-id-cat" type="hidden" name="idCategory" /><input id="form-type" type="hidden" /></form>
                    </div>
        ...
        <div><a class="btn btn-primary btn-fw" id="create" href="#" data-id="null" data-name="All">Add book to <span class="current-category" id="current-category">All</span></a></div>
